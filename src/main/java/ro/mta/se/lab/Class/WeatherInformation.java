 ...
 * Implementeaza clasa WeatherInformation
 * care reprezinta modelul arhitecturei
 * MVC
 *
...
public class WeatherInformation {
    ...
    /**
     * Constructor de clasa WeatherInformation
     */
    ...
    /**
     * Functie pentru obtinerea datelor
     * necesare afisarii GUI
     */
    public void Work(String responseBody){
        ...
        long sunRise = Long.parseLong(parser.getObject_getValue("sys", "sunrise",
                "long", responseBody));
        long sunSet = Long.parseLong(parser.getObject_getValue("sys", "sunset",
                "long", responseBody));
        ...
        this.descriptionField = parser.getArray_getObject_getValue("weather", "description",
                "String", responseBody);
        this.descriptionField = this.descriptionField.substring(0, 1).toUpperCase() +
                this.descriptionField.substring(1);

        String icon = parser.getArray_getObject_getValue("weather", "icon", "String",
                responseBody);

        this.icon = "http://openweathermap.org/img/wn/" + icon + "@2x.png";

        this.temperatureField = Integer.parseInt(parser.getObject_getValue("main", "temp",
                "int", responseBody));
        this.minTemperatureField = Integer.parseInt(parser.getObject_getValue("main", "temp_min",
                "int", responseBody));
        this.maxTemperatureField = Integer.parseInt(parser.getObject_getValue("main", "temp_max",
                "int", responseBody));
        this.pressureField = Integer.parseInt(parser.getObject_getValue("main", "pressure",
                "int", responseBody));
        this.humidityField = Integer.parseInt(parser.getObject_getValue("main", "humidity",
                "int", responseBody));
        this.windSpeed = Double.parseDouble(parser.getObject_getValue("wind", "speed",
                "double", responseBody));
    }

    /**
     * Geterele clasei WeatherInformation
     */
